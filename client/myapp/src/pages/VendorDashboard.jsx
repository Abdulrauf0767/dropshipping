...
const VendorDashboard = () => {
  ...
  const SideBarNav = [
    { icon: FiGrid, text: "Dashboard", link: "/vendor/dashboard" },
    { icon: LocalOffer, text: " Your Orders", link: "/vendor/your-orders" },
    { icon: AddBox, text: " Book Orders", link: "/vendor/book-orders" },
    { icon: AccountBalance, text: " Withdraw", link: "/vendor/withdraw-management" },
  ];

  const productSubmenu = [
    { icon: FiPlusSquare, text: "Add Product", link: "/vendor/uploadproduct" },
    { icon: LocalOffer, text: "Your Products", link: "/vendor/itself-products" },
  ];
